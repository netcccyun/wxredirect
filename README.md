...
这是一款基于ThinkPHP开发的微信公众号多域名回调系统。本系统有如下功能：
...
- QQ互联多域名回调功能：每个QQ互联应用只能配置1个网站回调地址，用本系统突破这个限制，可同时在多个网站使用同一个QQ互联应用。
...
🌐 作者信息：消失的彩虹海([https://blog.cccyun.cn](https://blog.cccyun.cn/))
